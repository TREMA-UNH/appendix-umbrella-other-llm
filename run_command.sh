# --prompt_mode can be changed to "zeroshot_basic" if needed
...
python src/main.py \
  ...
  --docs_path "./data/dl2023/llm4eval_document_2024.jsonl" \
  --prompt_mode "zeroshot_bing" \
  --result_file_path "./results/dl23_test_zeroshot_bing_Llama-3.3-70B.txt" \
  -together
  # --max_pair 1
...
python src/main.py \
  ...
  --docs_path "./data/dl2019/dl2019_document.jsonl" \
  --prompt_mode "zeroshot_bing" \
  --result_file_path "./results/dl19_test_zeroshot_bing_Llama-3.3-70B.txt" \
  -together
  # --max_pair 1
...
python src/main.py \
  ...
  --docs_path "./data/dl2020/dl2020_document.jsonl" \
  --prompt_mode "zeroshot_bing" \
  --result_file_path "./results/dl20_test_zeroshot_bing_Llama-3.3-70B.txt" \
  -together
#   --max_pair 1
